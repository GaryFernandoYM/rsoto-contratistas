...
<head>
    ...
    <!-- Main CSS File -->
    <link href="assets/css/jasovi.css" rel="stylesheet">
</head>
...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
            ...
            <a href="{{ route('jasovi') }}" class="logo d-flex align-items-center">
                <img src="{{ asset('assets/img/logos/jasovi_blanco.png') }}" alt="Logo Jasovi" class="me-2">
            </a>
            ...
            <div class="container">
                <div class="row gy-4 justify-content-between align-items-center">
                    ...
                    <div class="col-lg-4 order-lg-last hero-img position-relative" data-aos="zoom-out"
                        ...
                        <img src="{{ asset('assets/img/logos/jasovi/jasovi01 copy.png') }}"
                            class="position-absolute top-0 start-0 w-100 h-100 img-blur" alt="Imagen Jasovi fondo">

                        <!-- Imagen principal flotada con sombra -->
                        <img src="{{ asset('assets/img/logos/jasovi/jasovi01 copy.png') }}"
                            class="d-block w-100 img-fluid position-relative img-lift" alt="Imagen Jasovi"
                    ...
                    <div class="col-lg-6 d-flex flex-column justify-content-center text-white text-center text-lg-start"
                        ...
                        <!-- Marca corporativa grande -->
                        <h1 class="display-1 fw-bold mb-3" style="letter-spacing: 1px;">
                            JASOVI
                        </h1>

                        <!-- Submarca pequeña debajo -->
                        <h4 class="text-uppercase text-white-50 fw-semibold mb-4" style="letter-spacing: 2px;">
                            Ingeniería y Minería
                        </h4>

                        <!-- Mensaje fuerte de confianza -->
                        <p class="fs-5 fw-light mb-5 text-white-75">
                            Obras civiles, supervisión y asesoría técnica.<br class="d-none d-lg-block">
                            Más de [XX] años generando confianza y excelencia en cada proyecto.
                        </p>

                        <!-- Botones premium siempre en fila -->
                        <div class="d-flex justify-content-center justify-content-lg-start gap-3 flex-wrap">
                            ...
                            <a href="https://www.youtube.com/watch?v=TULrF1zWzcs"
                                class="glightbox btn btn-outline-light btn-lg rounded-pill d-flex align-items-center justify-content-center gap-2 px-4 py-2 shadow-sm fw-semibold">
                                <i class="bi bi-play-circle fs-4"></i><span>Ver Video</span>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row text-center justify-content-center g-4">
                    ...
                    <div class="col-12 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                        <div class="stats-card p-4 position-relative">
                            <div class="icon-circle mx-auto mb-4">
                                <i class="bi bi-building-check"></i>
                            </div>
                            <h3 class="fw-bold text-primary">+50</h3>
                            <p class="fs-5 text-muted">Obras ejecutadas<br>con calidad</p>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                        <div class="stats-card p-4 position-relative">
                            ...
                            <p class="fs-5 text-muted">Consultorías<br>realizadas</p>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                        <div class="stats-card p-4 position-relative">
                            ...
                            <h3 class="fw-bold text-primary">Certificados</h3>
                            <p class="fs-5 text-muted">Verificados online</p>
                        </div>
                    </div>
...
<!-- OBRAS EN EJECUCIÓN -->
    ...
    <footer id="footer" class="footer dark-background py-4">
        <div class="container text-center text-white">
            ...
            <!-- Logo o nombre -->
            <h5 class="fw-bold mb-3 text-uppercase">JASOVI Ingeniería y Minería</h5>
            ...
            <p class="small text-light mb-3">
                Email: <a href="mailto:contacto@jasovi.pe"
                    class="text-white text-decoration-none">contacto@jasovi.pe</a>
            </p>
            ...
            <!-- Copyright -->
            <p class="small text-white-50 mb-0">© <span id="year"></span> JASOVI Ingeniería y Minería. Todos los
